...
@Entity(
    ...
    indices = [
        Index(value = ["tmdbId", "mediaType"], unique = true),
        Index(value = ["imdbId"]),
    ],
)
data class LibraryItem(
    ...
    // Normalized float[256] embedding generated by OnDeviceEmbedder, stored
...
fun MediaResult.toLibraryItem(source: LibrarySource, imdbId: String? = null): LibraryItem = LibraryItem(
